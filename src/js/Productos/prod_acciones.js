    ...
    fetch("", {
      ...
      .then((data) => {
        ...
        data.map((caja) => {
          $(
            "#productos"
          )[0].innerHTML += `<div id="${caja[0]}" class="w-9rem position-relative h-9rem bg-apple rounded-2 d-flex flex-column align-items-center justify-content-end" style="overflow:hidden">
        ...
        $("*#btnEditar").map((id, value) => {
          $(value).click((e) => {
            ...
            $("#disponibles")[0].value = caja.disponibles;
